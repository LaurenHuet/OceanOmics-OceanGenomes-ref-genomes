...
echo -e "Filename\t# contigs\tContig N50\tContig N50 (Mb)\t# scaffolds\tScaffold N50\tScaffold N50 (Mb)\tLargest scaffold\tLargest scaffold (Mb)\tTotal scaffold length\tTotal scaffold length (Mb)\tGC content %" > final_gfastats_report.txt

tsv_files=$(find . -name "*final.assembly_summary")
